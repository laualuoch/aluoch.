...
const HomeItems = () => {
    return (
        ...
        <div>
            <img class="border-double border-4 border-green p-20 h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-2.jpg" alt="" />
        </div>

        <div>
            <img class="border-double border-4 border-green p-20 h-auto max-w-full rounded-lg"  src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-3.jpg" alt="" />
        </div>
    </div>
    )
};
